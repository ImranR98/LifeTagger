...
module.exports.getFileList = (mediaDir) => {
    ...
    allTargets = allTargets.map(file => {
    ...
    return { targetFiles: allTargets.slice(startIndex, startIndex + batchSize), allTargetsCount: allTargets.length }
}
